%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIESIM_Poly2Mat_cheb.m     PIETOOLS 2021a
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Constructs A - discrete matrix representation of the polymonial operator
%
% Inputs:
...
function [A, A_nonsquare]=PIESIM_Poly2Mat_cheb_new(N, Rop, p)
pvars = pvar(Rop.varname);
symvars = p2s(pvars);
% pvar s theta
