...
% --- solution.final.observed{2} - array of size (N+1) x noox - final value of INFINITE-DIMENSIONAL observed outputs
% --- solution.final.regulated{1} - array of size nro  - final value of FINITE-DIMENSIONAL regulated outputs
% --- solution.final.regulated{2} - array of size (N+1) x nrox - final value of INFINITE-DIMENSIONAL regulated outputs
