%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIESIM_time_integrate.m    PIETOOLS 2021d
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Performs time-advancement of a discretized PIE with the scheme specified
% by "opts.intScheme"=1, 2 or 3
% opts.intScheme=1 - Backward Differentiation Formula
% opts.intScheme=2 - Gauss integration of the matrix exponential formula
% opts.intScheme=3 - Analytical (symbolic) integration of the matrix
% exponential formula
%
% Inputs:
...
switch opts.intScheme 
     ...
     case 2
     solcoeff=PIESIM_int_gauss(psize, opts, uinput, coeff, Dop);
     case 3
