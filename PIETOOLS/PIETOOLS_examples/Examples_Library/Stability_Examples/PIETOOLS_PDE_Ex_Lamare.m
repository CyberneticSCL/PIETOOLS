function [PDE_t,PDE_b] = PIETOOLS_PDE_Ex_Lamare(index,GUI,params)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if index==2 || index==2.1
    ...
    Lm=[-3 0;0 1];
    Fm=[.2 -.3; .6 .1];
    dir = fullfile(root,'PIETOOLS_PDE_Ex_Lamare_Ex_5_1_GUI.mat');
elseif index==2.2
    % % Example 5.2
    Gm1=[.1];
    Gm2=[-.8];
    ...
    Lm=[-1 0;0 1];
    Fm=[-.3 .1; .1 -.3];
    dir = fullfile(root,'PIETOOLS_PDE_Ex_Lamare_Ex_5_2_GUI.mat');
elseif index==2.3
    % % Example 5.3
    Gm1=[-.2202];
    Gm2=[1.3955];
    ...
    Lm=[-1 0;0 2];
    Fm=[-.1 .1; .5 -.8];
    dir = fullfile(root,'PIETOOLS_PDE_Ex_Lamare_Ex_5_3_GUI.mat');
elseif index==2.4
    % % Example 5.4
    Gm1=[.5];
    Gm2=[-.4];
    ...
    dir = fullfile(root,'PIETOOLS_PDE_Ex_Lamare_Ex_5_4_GUI.mat');
else
