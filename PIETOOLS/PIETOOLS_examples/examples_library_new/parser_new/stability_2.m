...
%Gm1=[.1];Gm2=[-.8];Gm3=[.6];Gm4=[-.4];Lm=[-1 0;0 1];Fm=[-.3 .1; .1 -.3];
%Gm1=[-.2202];Gm2=[1.3955];Gm3=[-.0596];Gm4=[.2090];Lm=[-1 0;0 2];Fm=[-.1 .1; .5 -.8];
%Gm1=[.5];Gm2=[-.4];Gm3=[.2];Gm4=[.8];Lm=[-2 0;0 1];Fm=[-.6565 -.3743; -.113 -.6485];
