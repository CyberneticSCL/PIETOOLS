% Code testing proper functioning of blkdiag
...
% % % Use blkdiag and compare to polynomial result % % %
...
blk = blkdiag(D1,D2,D1,D2);
blk_poly = blkdiag(D1_poly,D2_poly,D1_poly,D2_poly);
error1 = dpvar2poly(blk) - blk_poly;
if max(error1.coeff,[],'all') >= tol
    error('blkdiag does not produce the desired polynomial')
end
...
disp('No errors were encountered testing blkdiag!')