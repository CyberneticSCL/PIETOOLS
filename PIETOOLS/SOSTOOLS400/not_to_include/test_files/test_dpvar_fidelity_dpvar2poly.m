% Code testing proper functioning of dpvar2poly
% The code builds a set of random dpvar objects and the associated polynomial
% objects, and checks whether the poylonomials produced using dpvar2poly
% are correct.
...
% % % Comparing polynomial to that produced with dpvar2poly % % %
D1_dp2poly = dpvar2poly(D1);

try 
    error1 = double(D1_poly - D1_dp2poly);
catch
    error('dpvar2poly does not produce the desired polynomial')
end
...
disp('No errors were encountered testing dpvar2poly!')