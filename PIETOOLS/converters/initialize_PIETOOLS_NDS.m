%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% initialize_PIETOOLS_NDS.m     PIETOOLS 2022
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function NDS_out=initialize_PIETOOLS_NDS(NDS)
% initializes and checks the NDS formulation as described at the end of
% this file. undefined signals are set to length 0 with 0 value.
%
% input: NDS - a partially-defined NDS data structure
%
% output: NDS - a fully-defined NDS data structure
...
%%%%%%%%%%%%%%%%%%%%%%%%%
% Dumping the data structure to the workspace. We are not bad people!
names=fieldnames(NDS);
for i=1:numel(names)
    eval([names{i},'=NDS.',names{i},';'])
end
