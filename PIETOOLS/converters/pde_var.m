...
if nargout==0
    ...
    for ii=1:nargin
        ...
        if strcmpi(varargin{ii},'state') || ...
                strcmpi(varargin{ii},'input') || strcmpi(varargin{ii},'in') || ...
                strcmpi(varargin{ii},'output') || strcmpi(varargin{ii},'out') || ...
                strcmpi(varargin{ii},'control') || strcmpi(varargin{ii},'actuate') || ...
                strcmpi(varargin{ii},'sense') || strcmpi(varargin{ii},'observe')
