%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS_FEPIE2PDEstability_2D.m     PIETOOLS 2026
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [prog, Qop, Dop, solve_val] = PIETOOLS_FEPIE2PDEstability_2D(PIE,settings)
% This script executes a FE PIE to PDE stability analysis for a 2D-PIE System
% defined by the PI operator representation
%       Top \dot{x}(t)=Aop x(t)
% testing whether solutions satisfy
%       \int_0^\infty ||Tx(t)||^2_{L_2}  dt \le C||x(0)||_{L_2}
%
...
if ~isfield(settings,'epneg')
    epneg = 1e-5;         % Negativity of Derivative of Lyapunov Function in both ODE and PDE state -  >0 if exponential stability desired
else
...
% % First, declare an indefinite operator Qop, such that Pop=QopTop=(QopTop)'
