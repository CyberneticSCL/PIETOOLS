function [prog,W, gam, R, Q] = PIETOOLS_H2_norm_2D_o_non_coercive(PIE, settings,options)
...
for j=1:length(LF_use_psatz)
    if LF_use_psatz(j)~=0
                [prog, R2op] = poslpivar_2d(prog, Pop.dim, LF_deg_psatz{j}, LF_opts_psatz{j});
                 Rop = Rop + R2op;
    end
end
...
[prog,Wm] = poslpivar_2d(prog,B1op.dim(:,2));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
