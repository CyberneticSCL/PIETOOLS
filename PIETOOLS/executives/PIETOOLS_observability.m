function [prog, Wc] = PIETOOLS_observability(PIE,settings,varargin)
if PIE.dim==2
...
[prog, Qop] = poslpivar(prog, [ny ,0],X,dd1,options1);
...
Dop =  (Aop'*Wop)*Top+Top'*(Wop*Aop)+C2op'*C2op;
