%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% executive_PIETOOLS_Hinf_gain_dual.m     PIETOOLS 2021b
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [prog, Pop, gam] = executive_PIETOOLS_Hinf_gain_dual(PIE, settings)
...
disp('Searching for Hinf gain bound using dual KYP lemma')
