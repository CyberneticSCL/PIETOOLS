...
% 
% INPUT
% obj: ndopvar class object to slice
% s: structure of indices used for reference (auto generated by matlab
% based on subscript expression
% 
% OUTPUT
% out: ndopvar object (if slicing the operator), otherwise depends on the
...
switch s(1).type
    ...
    case '()'
        ...
        dec_var_NEW = obj.dvarname; % nopvar no dec var
