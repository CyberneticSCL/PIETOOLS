...
% VARARGOUT = SIZE(A,DIM) returns the size of a 'quadpoly' object A along 
% dimension DIM
% 
% INPUTS:
% - A:      'quadpoly' object
...
%           quadpoly matrix along the specified dimension is returned
%       - if one output is called and no dim is specified, a 1x2 array
%           specifying [row,col] dimension of the quadpoly is returned
