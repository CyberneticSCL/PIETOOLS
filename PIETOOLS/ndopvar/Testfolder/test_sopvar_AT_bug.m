...
Bparams{1,1} = [rand(3*n2,1*n3),zeros(3*n2,2*n3)];
Bparams{2,1} = rand(3*n2,3*n3);
Bparams{3,1} = rand(3*n2,3*n3);
Aparams{1,1} = [rand(3*n1,1*n2),zeros(3*n1,2*n2)]; 
Aparams{2,1} = rand(3*n1,3*n2); 
Aparams{3,1} = rand(3*n1,3*n2); 
