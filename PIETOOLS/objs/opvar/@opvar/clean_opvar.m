...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% P1 = clean_opvar(P1,tol) removes terms from opvar P1 with coefficients
...
% 
% OUTPUT
% P1: opvar class object with only nontrivial terms retained
%
% NOTES:
...
for f=1:length(fset)
    ...
    elseif isa(PR,'polynomial')
        ...
        error('Parameters of an opvar class object must be of type "double" or "polynomial"')
    end
end
