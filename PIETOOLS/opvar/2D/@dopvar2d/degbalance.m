...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [d] = degbalance(P,opts) provides degrees to be selected in generating
% a positive operator Q = poslpivar_2d(P.dim,d) such that parameters 
% defining P and Q have similar polynomial degrees.
% 
% INPUT
