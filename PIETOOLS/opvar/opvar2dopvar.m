function dopVar = opvar2dopvar(dopVar)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
dopVar.P = poly2dpvar(opVar.P);
dopVar.Q1 = poly2dpvar(opVar.Q1);
dopVar.Q2 = poly2dpvar(opVar.Q2);
dopVar.R.R0 = poly2dpvar(opVar.R.R0);
dopVar.R.R1 = poly2dpvar(opVar.R.R1);
dopVar.R.R2 = poly2dpvar(opVar.R.R2);
end