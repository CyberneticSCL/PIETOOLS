...
x   = pde_var(s,dom);
bet = 1;
PDE = [diff(x,t)==diff(x,s,2)-bet*x*diff(x,s);
...
d_psatz1 = 0; % degree of distributed monomial in upper bound condition of LF (CONDITION ENFORCED GLOBALLY).
d_psatz2 = 0; % degree of distributed monomial in upper bound condition of LF derivative (CONDITION ENFORCED GLOBALLY).
