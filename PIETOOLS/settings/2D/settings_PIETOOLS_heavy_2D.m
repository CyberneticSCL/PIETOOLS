%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% settings_PIETOOLS_heavy_2D.m     PIETOOLS 2022a
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function settings = settings_PIETOOLS_heavy_2D()
% Settings file for more challenging LPIs in two spatial variables.
%
...
if nargin>0
    error(['The settings_heavy function does not take inputs.',...
...
% We have almost no freedom in constructing the operator D.    
    ...
    % present
    settings.ineq_opts.psatz = [1;2;3];
