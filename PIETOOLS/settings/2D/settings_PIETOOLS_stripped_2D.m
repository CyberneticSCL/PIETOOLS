%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%]
% settings_PIETOOLS_stripped_2D.m     PIETOOLS 2022a
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function settings = settings_PIETOOLS_stripped_2D()
...
if nargin>0
    error(['The settings_stripped function does not take inputs.',...
...
d2 = {[0,1;1,2],...             % Degree of Z2^oo(x,y) in [-, y; x, x*y]
      [0,1,1,1;1,2,2,2],...     % Degree of Z2^oa(x,y,nu) in [-, y, nu, nu*y; x, x*y, x*nu, x*y*nu]
      [0,1,1,1;1,2,2,2];...     % Degree of Z2^ob(x,y,nu) in [-, y, nu, nu*y; x, x*y, x*nu, x*y*nu]
      [0,1;1,2;1,2;1,2],...     % Degree of Z2^ao(x,y,tt) in [-, y; x, x*y; tt, y*tt; x*tt, x*y*tt]
      ...
      [0,1;1,2;1,2;1,2],...     % Degree of Z2^bo(x,y,tt) in [-, y; x, x*y; tt, y*tt; x*tt, x*y*tt]
