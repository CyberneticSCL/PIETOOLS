%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% settings_PIETOOLS_veryheavy_2D.m     PIETOOLS 2022a
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function settings = settings_PIETOOLS_veryheavy_2D()
% Settings file for very challenging LPIs in two spatial variables.
%
...
if nargin>0
    error(['The settings_veryheavy function does not take inputs.',...
...
dx = {1;            % Degree of Zx^o(x) in x
      [2;2;3];      % Degree of Zx^a(x,tt) in x, tt and (x*tt)
      [2;2;3]};     % Degree of Zx^b(x,tt) in x, tt and (x*tt)
  
% Monomials in just the second spatial variable y
dy = {1,...         % Degree of Zy^o(y) in y
      [2,2,3],...   % Degree of Zy^a(y,nu) in y, nu and (y*nu)
...
% We have almost no freedom in constructing the operator D.    
    ...
    % present
    settings.ineq_opts.psatz = [1;2;4];
