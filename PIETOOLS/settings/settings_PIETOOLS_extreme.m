function settings = settings_PIETOOLS_extreme()
% Returns settings structure with polynomials higher than 2nd order but
% lower than 4th and has lower triangular strucuture in square roots of
% positive PIs
...
settings.options1.exclude=[0 0 1 1]; % using LU or UL decomposition in the LF seems to have minimal impact...
...
if sosineq_on
    ...
    Dup=0;
    settings.override2=1;   % =0 to include Psatz in Derv
    ...
    settings.dd2 = {n_order1+Dup, [n_order2+Dup, n_order3+Dup, n_order4+Dup], [n_order2+Dup, n_order3+Dup, n_order4+Dup]};
...
%    dd3 = {n_order1+Dup, [n_order2+Dup, n_order3+Dup, n_order4+Dup], [n_order2+Dup-1, n_order3+Dup, n_order4+Dup]};
    settings.dd3 = {n_order1+Dup-1, [n_order2+Dup-1, n_order3+Dup-1, n_order4+Dup-1], [n_order2+Dup-2, n_order3+Dup-1, n_order4+Dup-1]};
    % % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
end
