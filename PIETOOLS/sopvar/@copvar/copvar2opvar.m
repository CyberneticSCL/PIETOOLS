function Pop = copvar2opvar(Pmop)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% POP = COPVAR2OPVAR(PMOP) takes a 'copvar' container over the spaces
% (R^m, L2^n[s]) and returns the equivalent 'opvar' object.
%
% INPUTS
% - Pmop:   'copvar' whose output and input spaces are the same list drawn
