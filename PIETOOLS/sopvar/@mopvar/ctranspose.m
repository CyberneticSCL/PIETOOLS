...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% At = CTRANSPOSE(A) returns the adjoint of a 'mopvar' object,
%
%       (A*)_{ij} = (A_{ji})*,
%
...
% storage.
%
% See also PLUS, MTIMES, MOPVAR.
%
% For support, contact M. Peet, Arizona State University at mpeet@asu.edu

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS - ctranspose(mopvar)
%
...
if ~isa(A,'mopvar')
    error('ctranspose:badInput','Input must be a mopvar object.')
end
