function C = plus(A,B)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% C = PLUS(A,B) adds two 'mopvar' objects blockwise, (A+B)_{ij} = A_{ij} +
% B_{ij}, following Sec. 8.2 of the sopvar document.
%
% INPUTS
% - A, B:   'mopvar' objects on the same grid, spaces and dimensions;
% OUTPUTS
% - C:      'mopvar' object equal to A + B;
%
% NOTES
...
% in 'mopvar'. Measured over the subset lattice at 2 components and degree
...
% here as well; see @mdopvar/plus.
%
% See also MTIMES, CTRANSPOSE, MOPVAR.
%
% For support, contact M. Peet, Arizona State University at mpeet@asu.edu

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS - plus(mopvar)
%
...
if ~isa(A,'mopvar') || ~isa(B,'mopvar')
    error('plus:badInput','Both summands must be mopvar objects.')
end
