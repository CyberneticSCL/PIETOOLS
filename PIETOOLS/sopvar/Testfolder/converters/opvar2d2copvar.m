function Pmop = opvar2d2copvar(Pop)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PMOP = OPVAR2D2COPVAR(POP) takes an 'opvar2d' object and returns the
% equivalent 4 x 4 'copvar' container.
%
% INPUTS
...
%
% OUTPUTS
% - Pmop:   'copvar' over the four spaces in opvar2d's own order,
...
%
% See also COPVAR2OPVAR2D, OPVAR2D2SOPVAR, OPVAR2COPVAR, RAND_COPVAR.
%
% For support, contact M. Peet, Arizona State University at mpeet@asu.edu

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS - opvar2d2copvar
%
...
if ~isequal(size(d),[4,2])
    error('opvar2d2copvar:badDim','opvar2d dim must be 4x2; got %s.',mat2str(size(d)))
end
