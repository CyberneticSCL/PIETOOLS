function prog = lpi_eq_mdopvar(prog,P,opts)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PROG = LPI_EQ_MDOPVAR(PROG,P) takes an LPI optimization program structure
% 'prog' and an 'mdopvar' decision operator P on a concatenation of mixed
...
% returned by 'posmopvar' and to sums and compositions of them.
%
...
%           'prog.decvartable';
% - P:      'mdopvar' object of which to enforce P==0;
...
%
% NOTES
% To enforce P==Q, call LPI_EQ_MDOPVAR(PROG,P+(-1)*Q); '@mdopvar/plus' aligns
...
% that neither 'mdopvar' nor 'mopvar' defines 'minus' or 'uminus', so P-Q is
% not executable; the scalar branch of '@mdopvar/mtimes' is what negates a
% container.
%
...
%
% See also LPI_EQ_SDOPVAR, LPI_EQ, POSMOPVAR, MOPQUADVAR, MDOPVAR.
%
% For support, contact M. Peet, Arizona State University at mpeet@asu.edu

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS - lpi_eq_mdopvar
%
...
if isa(P,'mopvar')
    error("Input of type 'mopvar' carries no decision variables; use 'eq' "...
          +"on its blocks to test whether it is zero.")
end
if ~isa(P,'mdopvar')
    error("Input must be of type 'mdopvar'.")
end
