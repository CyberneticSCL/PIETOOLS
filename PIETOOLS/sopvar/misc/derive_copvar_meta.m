...
%
% NOTES
% 'copvar' and 'cdopvar' duplicate their METHOD files, following how
...
%
% See also COPVAR, CDOPVAR.
%
% For support, contact M. Peet, Arizona State University at mpeet@asu.edu

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PIETOOLS - derive_copvar_meta
%
