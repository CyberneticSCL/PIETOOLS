...
function [prog, P] = PIETOOLS_stability_w_constraints(PIE,B, settings)
...
Dop = [PIE.T'*Qop*PIE.A+PIE.A'*Qop*PIE.T+epneg*PIE.T'*Pop*PIE.T]; 
Dop2 = [PIE.T'*Qop*PIE.T+lam*B'*B-PIE.T'*Pop*PIE.T];    
...
if sosineq_on
    ...
    prog = lpi_eq(prog,Dop2,'symmetric');
end
