...
if Pbig
    Pstr = "Too big to display. Use T.P";
end
if Q1big
    Q1str = "Too big to display. Use T.Q1";
end
if Q2big
    Q2str = "Too big to display. Use T.Q2";
end
if R0big
    R0str = "Too big to display. Use T.R.R0";
end
if R1big
    R1str = "Too big to display. Use T.R.R1";
end
if R2big
    R2str = "Too big to display. Use T.R.R2";
end
