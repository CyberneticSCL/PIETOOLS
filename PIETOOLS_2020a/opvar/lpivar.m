...
[prog,P] = sosmatrvar(prog,monomials(var1,0),[n(1,1) n(1,2)]);
[prog,Q1] = sosmatrvar(prog,Zs,[n(1,1) n(2,2)]);
[prog,Q2] = sosmatrvar(prog,Zs,[n(2,1) n(1,2)]);
[prog,R0] = sosmatrvar(prog,Zs,[n(2,1) n(2,2)]);
...
[prog,R1] = sosmatrvar(prog,Zsth,[n(2,1) n(2,2)]);
[prog,R2] = sosmatrvar(prog,Zsth,[n(2,1) n(2,2)]);
