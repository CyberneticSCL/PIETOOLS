...
[f, c] = urlwrite('http://control.asu.edu/pietools/PIETOOLS_2020a.zip', 'PIETOOLS_2020a.zip');
rehash;

% unzip PIETOOLS
disp("Extracting PIETOOLS files");
unzip('PIETOOLS_2020a.zip');
delete PIETOOLS_2020a.zip;
