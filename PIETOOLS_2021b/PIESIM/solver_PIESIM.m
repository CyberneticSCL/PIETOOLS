...
init_option=1;
%------------------------------------------------------------------------------
% example = xxx (between 1 and 34) to correspond to an Example number in
% the Library
if (init_option==1)
    example=9;
    if (example<1|example>34)
...
if (init_option==2)
    ...
    %
    % Optional inputs: initial conditions, inhomogeneous inputs uinput,
    % winput 
