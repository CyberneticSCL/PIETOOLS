...
% 
% INPUT
% T:    opvar2d class objects for which to establish the dimensions
...
%   ^ Based heavily on "@polynomial"-size code by PS ^
...
% For three inputs, return a slice of the full dimensions of the opvar2d
% object
elseif nargin == 3
    if strcmp(dim1,':') || strcmp(dim1,'all')
