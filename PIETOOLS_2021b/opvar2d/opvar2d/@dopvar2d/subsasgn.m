...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% b = subsasgn(a,L,RHS) assigns values RHS to field/slice L of a dopvar2d 
% object a
%
% Version 1.0
% Date: 07/12/21
...
switch L(1).type
    ...
    case '()'
        error('()- like subsassign is currently not supported for dopvar2d objects.');
