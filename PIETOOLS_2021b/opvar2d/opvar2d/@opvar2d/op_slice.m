...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Psop=op_slice(Pbop,indr,indc) extracts slice from an operator 
...
% 
% OUTPUT
% Psop: slice of the opvar2d object
%  
% NOTES:
...
for i=indr %rows
    ...
    elseif i<(n0_old+nx_old+ny_old+n2_old+1)
        ...
        error('index exceeds the number of rows in the original opvar2d')
    end
end
